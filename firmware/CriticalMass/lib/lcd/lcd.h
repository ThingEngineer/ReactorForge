...
#define LCD_H
/*************************************************************************
 Title	:   C include file for the HD44780U LCD controller (lcd.c)
...
/**
 Routines for interfacing with an HD44780U-based LCD display in 4-bit IO port mode

 Originally based on Volker Oth's and Peter Fleury's LCD library,
